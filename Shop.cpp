...
Shop::Shop() : Price(0) {}
Shop::Shop(int price) : Price(price) {}
void Shop::set_Item_Price(int price) { this->Price = price; }
int Shop::get_price() const { return Price; }
...
void Car_Shop::set_Car_Width(int Car_Width) { Cars.set_Car_Width(Car_Width); }
void Car_Shop::set_Car_Height(int Car_Height) { Cars.set_Car_Height(Car_Height); }
void Car_Shop::set_Car_Color(int Car_Color) { Cars.set_Car_Color(Car_Color); }
Car Car_Shop::get_Car() const { return Cars; }
int Car_Shop::get_Car_Color() const { return Cars.get_Car_Color(); }
